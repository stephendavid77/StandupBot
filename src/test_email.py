...
def run_test_email():
    ...
    try:
        ...
        print("Error: config.yaml not found. Please ensure it exists and is correctly configured.")
        return
    ...
    if not recipient_emails:
        print("Error: No recipient emails configured in config.yaml under 'run_settings.email_recipient_email'.")
